...
//             panel.add(buildSidebarButton(item));
//         }
...
//     private JPanel buildSidebarButton(String label) {
//         JPanel itemPanel = new JPanel(new BorderLayout());
//         itemPanel.setBackground(NAVY);
//         itemPanel.setMaximumSize(new Dimension(220, 46));
//         itemPanel.setBorder(BorderFactory.createEmptyBorder(10, 20, 10, 10));
...
//         // Landscape home: LIGHT_GRAY bg + wide icon row matching app palette (NAVY / TEAL)
...
//         greeting.setBorder(BorderFactory.createEmptyBorder(0, 0, 20, 0));
...
//                 g2.fillOval(0, 0, getWidth(), getHeight());
//                 g2.setColor(new Color(0x5B, 0x6A, 0xE0));
...
//         pill.setOpaque(true);
//         pill.setBackground(new Color(0xF0, 0xF2, 0xF8));
...
//                 new StudentDashboardGUI("Anubhav Gupta", "26CSE9999001", "B.Tech", "Computer Science Engineering")
//                         .setVisible(true));
//     }
// }